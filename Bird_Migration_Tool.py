...
# Corridorzone voor BE/NL/NO-Frankrijk/NW-Duitsland.
# Ondergrens: 50.0°N van 0.9°E t/m 13.9°E
# Bovengrens: 55.0°N van 8.7°E t/m 12.6°E
# Daardoor wordt de vroegere brede rechthoek vervangen door een smallere,
# trapeziumvormige corridor die beter aansluit bij het werkelijke rastergebied.
...
def migratie_bereken_score_uitgebreid(
    ...
    Regionale correctie BE/NL-corridor:
...
with tabs[2]:
    st.header("🦅 Migratie Raster — Vandaag + 7 Dagen")
    with st.expander("ℹ️ Extra informatie"):
        st.markdown("""
    Migratievoorspelling voor **vandaag + 7 dagen** op basis van weergegevens voor een configureerbaar raster
    ...
    **Wetenschappelijke factoren (gemiddeld over alle 24 uur per dag — dag én nacht):**
    ...
    🌟 **BE/NL-corridorcorrectie** (50.0°N 0.9°E → 50.0°N 13.9°E → 55.0°N 12.6°E → 55.0°N 8.7°E)
    — vogels gestuwd vanuit centraal-Frankrijk
    ...
    📦 **Aanvoercorrectie vanuit het zuiden** (BE/NL-corridor):
        ...
        for punt in raster_dag:
            ...
            popup_html = (
                ...
                + (
                    ...
                    f"🌟 BE/NL-corridor: ZO-wind (3–5 Bf) = optimaal</span>"
